            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="form_section">
                        <form action="" method="post" id="add_order_form">
                          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" class="csrf_token" />
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <label for="total_leads">Total Leads</label>
                              <input type="number" name="total_leads" class="form-control all_inputs" id="total_leads" placeholder="Total Leads">
                          ...
                          <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="number" name="amount" class="form-control all_inputs" id="amount" placeholder="Total Leads">
                              <span class="all_errors" id="amount_error"></span>
                            </div>
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-12">
                                <button type="button" id="add_order_btn" class="btn btn-primary">Add Order</button>
                            </div>
                          </div>
                        </form>
                    </div>

  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="dashboard-section">
          <h1>List of SMS Orders <span class="orange-text"></span></h1>
          <div class="row">
              <div class="col-md-3 col-sm-4 col-xs-4 col-md-offset-3"> 
                <div class="leades total">
                  <div class="no"><?php echo (isset($total_orders))?$total_orders:'' ;?></div>Total SMS Orders</div>
              </div>
          ...
          <div class="row" style="margin-top: 20px;">
            <div class="col-md-2">
               <a href="<?php echo base_url('sms_order');?>" class="dashboard-btn">New Order</a>
            </div>
          </div>
          <div class="row" style="margin-top: 20px;">
            <div class="col-md-12"> 
              <div class="table-list">        
                <table class="table-responsive table-bordered table-striped table-hover" width="100%" id="sample_sms_orders">
                <thead>
                <tr>
                  <th>Ordered SMS</th>
                  <th>Remaining SMS</th>

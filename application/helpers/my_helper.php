...
function send_email_to($name='',$email='',$message='',$subject='')
{
    ...
    $CI->email->initialize(array(
        'protocol'     => 'smtp',
        //'smtp_host'    => 'mail.debtmonster.co.uk',
        'smtp_host'    => 'mail.uflowexpress.co.uk',
        'smtp_port'    => '587',
        'smtp_timeout' => '7',
  ...
  <tr>
    <td align="center" valign="top" ><br>      
      ...
      <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="width:600px;max-width:600px">
        <tr><td align="left" style="font-size:18px;font-weight:bold;padding-bottom:12px;color:#a964a7;padding-left:5px;padding-right:5px"><img src="'.site_url('assets/images/logo-dm.png').'" width="189" height="120" alt=""/>
        ...
        <tr>
          ...
          <div class="mob" style=" position: absolute; right: -45px; top: -45px;"><img src="'.site_url('assets/images/bg-image.png').'"  alt=""/></div>
          <div style="font-size:25px;font-weight:700;color:#e9ac1e"> Hi,</div>
           <div style="font-size:25px;font-weight:700; padding-bottom: 35px; color:#a964a7">'.$name.'! </div>
